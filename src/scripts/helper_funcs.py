...
def save_checkpoint(ckpt_dir,step,model_data,optimizer_data,scheduler_data,scaler_data,meta_data,artifact,wandb_run):
    ...
    scaler_path = os.path.join(ckpt_dir,f"scaler_{step:05d}.pt")
    ...
    torch.save(scaler_data,scaler_path)
